...
4. The main results - now I understand how Pandas works and can use it in my personal projects.
5. Don't plan to change my learning strategy. One thing I noticed: it is much more efficient to learn instructions when you type them every time from scratch, rather than copy them from previous lines and change to fit the purpose.